#!/bin/bash
sample_list=('scA_4007-01_WES' 'scA_4009-01_WES' 'scA_4010-01_WES' 'scA_4003-01_WES')
...
do
  echo "#BSUB -J BL_WES_${sample}" >> ${sample}.lsf
	...
	echo "--input1 \"/rsrch4/home/lym_myl_rsch/Green_Lab_NGS2/DLBCL_scAtlas/Raw_data/MedGenomeP2006445/Batch2/WES/${sample}_R1.fastq.gz\" \\" >> ${sample}.lsf
	echo "--input2 \"/rsrch4/home/lym_myl_rsch/Green_Lab_NGS2/DLBCL_scAtlas/Raw_data/MedGenomeP2006445/Batch2/WES/${sample}_R2.fastq.gz\" \\" >> ${sample}.lsf
